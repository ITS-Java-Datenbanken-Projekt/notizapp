...
public class GUI extends javax.swing.JFrame {
    ...
    try {
        result = this.konnektor.fuehreAbfrageAus("SELECT n.Titel, n.Inhalt FROM notiz n JOIN Ordner o ON n.Ordner_ID = o.Ordner_ID JOIN user u ON o.Benutzername = u.Benutzername WHERE u.Benutzername = '" + login.uebergebeuser().getName() + "' AND o.Name = '" + ordnerName + "';");
        while(result.next()) {
